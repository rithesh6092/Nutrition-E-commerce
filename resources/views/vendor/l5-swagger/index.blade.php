...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ secure_asset($documentation, 'swagger-ui.css') }}">
    <link rel="icon" type="image/png" href="{{ secure_asset($documentation, 'favicon-32x32.png') }}" sizes="32x32"/>
    <link rel="icon" type="image/png" href="{{ secure_asset($documentation, 'favicon-16x16.png') }}" sizes="16x16"/>
    <style>
    html
    {
...
<script src="{{ secure_asset($documentation, 'swagger-ui-bundle.js') }}"></script>
<script src="{{ secure_asset($documentation, 'swagger-ui-standalone-preset.js') }}"></script>
<script>
